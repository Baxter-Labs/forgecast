...
export type KeyId = 'fal' | 'fal_video' | 'fal_voice' | 'openai' | 'anthropic' | 'pexels' | 'wisprflow';
...
export const KEY_CATALOG: readonly KeyDef[] = [
  ...
  { id: 'openai', label: 'OpenAI', env: 'OPENAI_API_KEY', group: 'Agent brain', hint: 'the PLAN / AUTO-RUN agent + the editor agent (default brain)' },
