...
describe('characters', () => {
  ...
  it('MCP: create + list + generate with character, ownership enforced', async () => {
    ...
    expect(names).toEqual(expect.arrayContaining(['forgecast_create_character', 'forgecast_list_characters', 'forgecast_delete_character', 'forgecast_generate_presenter']));
